...
.empulse{
  ...
  <body>
<h1 class="empulse" style = "font-size:120px;margin-bottom:0px;text-shadow: 5px 5px #3d47ff;"><b>EMPULSE</b></h1>
<h3 class="empulse"> AN EMPLOYEE LEAVE MANAGEMENT SYSTEM </h3>
