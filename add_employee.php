...
if(isset($_POST['submit'])){
	...
	if($id>0){
		$sql="update employee set name='$name',gender='$gender',email='$email',mobile='$mobile',password='$password',department_id='$department_id',address='$address',birthday='$birthday',role='$role' where id='$id'";
	}else{
		$sql="insert into employee(name,gender,email,mobile,password,department_id,address,birthday,role) values('$name','$gender','$email','$mobile','$password','$department_id','$address','$birthday','$role')";
	}
                           ...
                           <form method="post">
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<input type="number" value="<?php echo $role?>" name="role" placeholder="Enter employee role" class="form-control" required>
								</div>
